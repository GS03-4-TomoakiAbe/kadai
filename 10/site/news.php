        ...
        <section id="news_lower">
            ...
            <div class="inner clearfix">
                <div class="section-heading-wrap">
                    ...
                    <p class="section-note"><?=htmlEnc($val["indate"])?></p>
                </div>
            </div>
            </div>
            ...
            <div class="inner">
                <ul class="news_list clearfix">
                    <li> 
                    <dl>
	                    <dt class="news-date clearfix"><span class="news_tags"><?=htmlEnc($val["news_title"])?></span>
	                    </dt>
	                    <dd class="news-title"><?=htmlEnc($val["news_detail"])?></dd>
	                    </dl>
                    </li>
                </ul>
            </div>
